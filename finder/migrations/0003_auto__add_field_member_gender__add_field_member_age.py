...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'finder_member', 'gender',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=10),
                      keep_default=False)

        # Adding field 'Member.age'
        db.add_column(u'finder_member', 'age',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'finder_member', 'gender')

        # Deleting field 'Member.age'
        db.delete_column(u'finder_member', 'age')
