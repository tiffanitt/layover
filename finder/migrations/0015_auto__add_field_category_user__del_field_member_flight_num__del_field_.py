...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Member.flight_num'
        db.delete_column(u'finder_member', 'flight_num')

        # Deleting field 'Member.airline'
        db.delete_column(u'finder_member', 'airline')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Member.flight_num'
        db.add_column(u'finder_member', 'flight_num',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=30),
                      keep_default=False)

        # Adding field 'Member.airline'
        db.add_column(u'finder_member', 'airline',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=30),
                      keep_default=False)
    ...
    models = {
        ...
        u'finder.category': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'category_user'", 'to': u"orm['finder.Member']"})
        },
        u'finder.event': {
